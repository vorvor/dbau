 ...
 */
function dbau_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['dbau_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('dbau sample setting'),
  '#default_value' => theme_get_setting('dbau_example'),
